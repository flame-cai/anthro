...
# When installed from wheel, data/ is bundled alongside this module.
# When run directly from the repo, data/ lives two levels up.
_PKG_DATA  = os.path.join(os.path.dirname(__file__), "data")
_REPO_DATA = os.path.join(os.path.dirname(__file__), "..", "..", "data")
_DATA_DIR  = _PKG_DATA if os.path.isdir(_PKG_DATA) else _REPO_DATA
